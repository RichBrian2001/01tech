 ...
 * meta : {
    noCache: true                   // 如果设置为true，则不会被 <keep-alive> 缓��(默认 false)
    title: 'title'                  // 设置该路��在侧边栏和面包屑中展示的名字
...
export const constantRoutes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'yield',
        component: () => import('@/views/analysis/YieldAnalysis'),
        name: 'YieldAnalysis',
        meta: { title: '作物产量分析', icon: 'nested' }
      },
      {
        path: 'price',
